  ...
  return (
    <footer id="contact" className="border-t border-border py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <ScrollReveal staggerChildren={0.15} className="grid md:grid-cols-2 gap-12 mb-12">
          <ScrollRevealItem>
            ...
            <div className="space-y-2 text-foreground/60">
              <p>
                <a 
                  href="mailto:mateendeveloper@gmail.com" 
                  className="hover:text-foreground transition-colors"
                >
                  mateendeveloper@gmail.com
                </a>
              </p>
            </div>
          </ScrollRevealItem>
        ...
        <ScrollReveal className="border-t border-border pt-8 text-sm text-foreground/60 flex flex-col md:flex-row justify-between items-center">
